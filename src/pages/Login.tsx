...
const Login = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    toast({
      title: "Welcome back! 🌱",
      description: "Successfully logged into Importrade",
    });
    navigate("/dashboard");
  };
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to the Importrade community",
    });
    navigate("/dashboard");
  };
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-gradient-fresh text-white">
                  Sign In
                </Button>
              </form>
            </TabsContent>
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-gradient-nature text-white">
                  Create Account
                </Button>
              </form>
            </TabsContent>
